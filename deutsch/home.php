                    ...
                    <div class="col-12">
                        <div class="hero-slides-content">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent vel tortor
                                ...
                                sit amet laoreet neque. Fusce sagittis suscipit sem.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="hero-slides-content">
                            ...
                            <a class="nav-link" href="blog.php">
                                <h2>Touristische Attraktionen</h2>
                            </a>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent vel tortor
                                facilisis, volutpat nulla placerat, tincidunt mi. Nullam vel orci dui. Suspendisse
                                sit amet laoreet neque. Fusce sagittis suscipit sem.
                ...
                <div class="row h-100 align-items-end">
                    <div class="col-12">
                        <div class="hero-slides-content">
                            <div class="line"></div>
                            <a class="nav-link" href="elements.php">
                                <h2>Gesundheits- und Notfallzentren</h2>
                            </a>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent vel tortor
                                facilisis, volutpat nulla placerat, tincidunt mi. Nullam vel orci dui. Suspendisse
                                sit amet laoreet neque. Fusce sagittis suscipit sem.
                ...
                <div class="row h-100 align-items-end">
                    <div class="col-12">
                        <div class="hero-slides-content">
                            <div class="line"></div>
                            <a class="nav-link" href="contact.php">
                                <h2>Gemeinde und Gemeindeverwaltungen</h2>
                            </a>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent vel tortor
                                facilisis, volutpat nulla placerat, tincidunt mi. Nullam vel orci dui. Suspendisse
                                sit amet laoreet neque. Fusce sagittis suscipit sem.
                ...
                <div class="row h-100 align-items-end">
                    <div class="col-12">
                        <div class="hero-slides-content">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent vel tortor
                                facilisis, volutpat nulla placerat, tincidunt mi. Nullam vel orci dui. Suspendisse
                                sit amet laoreet neque. Fusce sagittis suscipit sem. <a class="nav-link" href="blog.php">Blog</a>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row h-100 align-items-end">
                    <div class="col-12">
                        <div class="hero-slides-content">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent vel tortor
                                facilisis, volutpat nulla placerat, tincidunt mi. Nullam vel orci dui. Suspendisse
                                sit amet laoreet neque. Fusce sagittis suscipit sem. <a class="nav-link" href="portfolio.php">Portfolio</a>
                            </p>
                        </div>
                    </div>
                </div>
