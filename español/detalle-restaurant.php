    ...
    <div class="card-body" style="margin-bottom:5%;padding: 9%;">
        ...
        <div class="row" >
            ...
            <div class="container text-center">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <img src="../images/restaurantes/tratoria/foto1.jpg" class="img-responsive" style="width:100%;cursor:pointer;" alt="Image"
                        onclick="openModal();currentSlide(2)"> 
                    </div>
                    <div class="col-sm-4"> 
                        <img src="../images/restaurantes/tratoria/foto2.jpg" class="img-responsive" style="width:100%;cursor:pointer;" alt="Image"
                        onclick="openModal();currentSlide(3)">
                    </div>
                    <div class="col-sm-4"> 
                        <img src="../images/restaurantes/tratoria/foto3.jpg" class="img-responsive" style="width:100%;cursor:pointer;" alt="Image"
                        onclick="openModal();currentSlide(4)">
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-4">
                    <img src="../images/restaurantes/tratoria/foto10.jpg" class="img-responsive" style="width:100%;cursor:pointer;" alt="Image"
                    onclick="openModal();currentSlide(5)">
                    </div>
                    <div class="col-sm-4"> 
                    <img src="../images/restaurantes/tratoria/foto4.jpg" class="img-responsive" style="width:100%;cursor:pointer;" alt="Image"
